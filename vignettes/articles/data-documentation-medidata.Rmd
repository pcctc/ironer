...
As of June 2024, all cancer treatments are consolidated into a single data frame (`ca_cm`).
...
These two tables contain all information in the original `ca_cm` table, and additionally provides:
