...
|---------|---------------|--------------------|---------------------------------|
| v1, v2  | [IRONMAN_Registry_Protocol_v2_Physician_Questionnaire.pdf](https://github.com/pcctc/ironer/tree/main/vignettes/articles/pqs/IRONMAN_Registry_Protocol_v3_Physician_Questionnaire.pdf)             | `pq`               | `discpq`                        |
