...
For example, in the `treatment` table the field `exstdat` (treatment start date) there is:
...
| `exstdat_int` | Start date where unknown month or day are imputed as `1`; unknown year imputed as `1900` | Date      | Yes                      |
...
path_pdf <- list(
  file.path("articles", "pqs", "IRONMAN_Registry_Protocol_v2_Physician_Questionnaire.pdf"),
  file.path("articles", "pqs", "IRONMAN_Registry_Protocol_v3_Physician_Questionnaire.pdf"),
  file.path("articles", "pqs", "IRONMAN_Registry_Protocol_v4_Physician_Questionnaire.pdf"),
  file.path("articles", "pqs", "IRONMAN_Registry_Protocol_v5_Physician_Questionnaire.pdf")
)
```
...
|---------|---------------|--------------------|---------------------------------|
| v1, v2  | [IRONMAN_Registry_Protocol_v2_Physician_Questionnaire.pdf](articles/pqs/IRONMAN_Registry_Protocol_v2_Physician_Questionnaire.pdf)              | `pq`               | `discpq`                        |
| v3      | [IRONMAN_Registry_Protocol_v3_Physician_Questionnaire.pdf](articles/pqs/IRONMAN_Registry_Protocol_v3_Physician_Questionnaire.pdf)              | `new_pq`           | `discpq`                        |
| v4      |  [IRONMAN_Registry_Protocol_v4_Physician_Questionnaire.pdf](articles/pqs/IRONMAN_Registry_Protocol_v4_Physician_Questionnaire.pdf)             | `new_pq_v4`        | `newdisc_pqv4`                  |
| v5, v6  |   [IRONMAN_Registry_Protocol_v5_Physician_Questionnaire.pdf](articles/pqs/IRONMAN_Registry_Protocol_v5_Physician_Questionnaire.pdf)            | `new_pq_v5`        | `newdisc_pqv5`                  |
...
IRONMAN collects genetic testing reports.
A new CRF was implemented in November 2022 to better capture and deliver genetic information, and is pending completion by sites and not yet ready to be delivered.
