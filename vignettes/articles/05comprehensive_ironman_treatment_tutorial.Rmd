...
Each entry includes treatment name, start date, end date, dose, modification reason, discontinuation reason, indication, and is this treatment a part of a clinical trial. Indication and is this treatment a part of a clinical trial was added June 2024 when the prior and on study treatment forms were consolidated to a single form.
...
The Physician Questionnaire (PQ) should be completed by the treating physician at baseline and for all treatment changes occurring while on study. Each questionnaire asks what treatments the patient has received so far and which
...
+==================+===================+==========================================================================================================================================+==================================================================================+
| Versions 1 and 2 | pq                | Please list this patient’s CURRENT / CHANGE IN TREATMENT(S)                                                                              | Open text field                                                                  |
|                  |                   |                                                                                                                                          |                                                                                  |
...
+------------------+-------------------+------------------------------------------------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------+
| Versions 5 and 6 | new_pq_v5         | What systemic treatment(s) has your patient received so far and which one(s) ishe starting now? In both columns, choose all that apply.  | -   Abiraterone                                                                  |
|                  |                   |                                                                                                                                          |                                                                                  |
|                  |                   |                                                                                                                                          | -   Androgen deprivation (LHRH, surgical)                                        |
|                  |                   |                                                                                                                                          |                                                                                  |
|                  |                   |                                                                                                                                          | -   Apalutamide                                                                  |
